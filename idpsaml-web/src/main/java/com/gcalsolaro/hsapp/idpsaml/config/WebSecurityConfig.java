package com.gcalsolaro.hsapp.idpsaml.config;
...
import com.gcalsolaro.hsapp.idpsaml.service.SAMLUserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter implements InitializingBean, DisposableBean {
	 ...
	 * It represents a bean definition with the aim allow wiring from other classes performing the Inversion of Control (IoC).
	 * 
	 * @throws Exception
	 */
	@Bean
